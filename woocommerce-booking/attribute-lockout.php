                            ...
                            if ( isset( $attr_lockout ) && $attr_lockout > 0 ) { //lockout is set at the attribute level
                                ...
                                foreach ( $bookings_array as $date_key => $date_value ) {
                                    ...
                                    if ( $final_qty > $attr_lockout ) {
                                        ...
                                        $message = $post_title->post_title . bkap_get_book_t( 'book.limited-booking-date-msg1' ) . $availability . " " . $attributes[ $attr_name ][ 'name'] . bkap_get_book_t( 'book.limited-booking-date-msg2' ) . $date_value . '.';
                        ...
                        if ( isset( $attr_settings[ 'booking_lockout_as_value' ] ) && 'on' == $attr_settings[ 'booking_lockout_as_value' ] && isset( $attr_settings[ 'booking_lockout' ] ) && $attr_settings[ 'booking_lockout' ] > 0 ) {
                            ...
                            if ( isset( $attr_lockout ) && $attr_lockout > 0 ) { //lockout is set at the attribute level
                                ...
                                if ( $final_qty > $attr_lockout ) {
                                    ...
                                    $message = $post_title->post_title . bkap_get_book_t( 'book.limited-booking-date-msg1' ) . $availability .  " " . $attributes[ $attr_name ][ 'name'] . bkap_get_book_t( 'book.limited-booking-date-msg2' ) . $booking_date . '.';
                                    wc_add_notice( __( $message, 'woocommerce-booking' ), $notice_type = 'error');
                                    $quantity_check_pass = 'no';
                                }
                        ...
                        if ( isset( $attr_settings[ 'booking_lockout_as_value' ] ) && 'on' == $attr_settings[ 'booking_lockout_as_value' ] && isset( $attr_settings[ 'booking_lockout' ] ) && $attr_settings[ 'booking_lockout' ] > 0 ) {
                            ...
                            if ( isset( $attr_lockout ) && $attr_lockout > 0 ) { //lockout is set at the attribute level
                                ...
                                if ( $final_qty > $attr_lockout ) {
                                    ...
                                    $message = $post_title->post_title . bkap_get_book_t( 'book.limited-booking-msg1' ) . $availability .  " " . $attributes[ $attr_name ][ 'name'] . bkap_get_book_t( 'book.limited-booking-msg2' ) . $booking_time . '.';
                                    wc_add_notice( __( $message, 'woocommerce-booking' ), $notice_type = 'error');
                                    $quantity_check_pass = 'no';
                                }
                            ...
                            if ( is_array( $get_order_item_ids ) && count( $get_order_item_ids ) > 0 ) {
                                ...
                                foreach ( $order_dates as $k => $v ) {
                                    ...
                                    if ( $attr_lockout > 0 && $attr_lockout < $final_qty ) {
                                        ...
                                        $message = $post_title->post_title . bkap_get_book_t( 'book.limited-booking-date-msg1' ) . $available_tickets .  " " . $attributes[ $attr_name ][ 'name'] . bkap_get_book_t( 'book.limited-booking-date-msg2' ) . $v . '.';
                                        wc_add_notice( __( $message, 'woocommerce-booking' ), $notice_type = 'error');
                                    }
                                }
                        ...
                        if ( is_numeric( $attr_qty_booked ) ) {
                            ...
                            if ( is_array( $get_order_item_ids ) && count( $get_order_item_ids ) > 0 ) {
                                ...
                                if ( $attr_lockout > 0 && $attr_lockout < $final_qty ) {
                                    ...
                                    $message = $post_title->post_title . bkap_get_book_t( 'book.limited-booking-date-msg1' ) . $available_tickets .  " " . $attributes[ $attr_name ][ 'name'] . bkap_get_book_t( 'book.limited-booking-date-msg2' ) . $booking_date . '.';
                                    wc_add_notice( __( $message, 'woocommerce-booking' ), $notice_type = 'error');
                                }
                        ...
                        if( is_numeric( $attr_qty_booked ) ) {
                            ...
                            if ( is_array( $get_order_item_ids ) && count( $get_order_item_ids ) > 0 ) {
                                ...
                                if ( $attr_lockout > 0 && $attr_lockout < $final_qty ) {
                                    ...
                                    $message = $post_title->post_title . bkap_get_book_t( 'book.limited-booking-msg1' ) . $available_tickets .  " " . $attributes[ $attr_name ][ 'name'] . bkap_get_book_t( 'book.limited-booking-msg2' ) . $booking_time . '.';
                                    wc_add_notice( __( $message, 'woocommerce-booking' ), $notice_type = 'error');
                                }
                            } else{
                                if ( $attr_lockout > 0 && $attr_lockout < $attr_qty_booked ) {
